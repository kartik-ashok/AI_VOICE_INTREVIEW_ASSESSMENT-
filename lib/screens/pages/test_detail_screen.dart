          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.white,
                  borderRadius: BorderRadius.circular(ResponsiveSize.width(15)),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black.withOpacity(0.1),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  questionAnswer.question,
                  style: TextStyle(fontSize: ResponsiveSize.font(15)),
                ),
                  ...
                  children: [
                    ...
                    if (!hasAiFeedback && !isLoading)
                      ElevatedButton.icon(
                        ...
                        label: Text(
                          'Get AI Feedback',
                          style: TextStyle(fontSize: ResponsiveSize.font(14)),
                        ),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Colors.green,
                          foregroundColor: Colors.white,
